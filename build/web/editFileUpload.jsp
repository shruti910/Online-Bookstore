<%-- 
    Document   : editFileUpload
    Created on : Jul 19, 2017, 10:15:41 PM
    Author     : User
--%>
    ...
    try {
        ...
        writer.println("<br/> ERROR: " + fne.getMessage());
                   ...
                   if (request.getParameter("submit") == null) {
                        ...
                        ps.executeUpdate(); 
                        %>
                        <div  class="jumbotron text-center"><h2> Book Details Updated Successfully</h2></div>
                        <br/> <a href="admin.jsp"> Go Back</a>
                        <%}catch(Exception e) {%>
                <div style="color:blue;"> <%=e %></div>
                 <%  }} %>
