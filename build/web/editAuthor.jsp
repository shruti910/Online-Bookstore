<%-- 
    Document   : editAuthor
    Created on : Jul 11, 2017, 11:59:28 AM
    Author     : User
--%>
...
<html lang="en" class="no-js">
 ...
 <a href="admin.jsp"> Back to Admin Page </a>
                ...
                <a href="editAuthor.jsp" class='active'>Add/Delete Authors</a>
...
<div class="tab-content">
	<div class=" active row" >  
            <h3 class="form-heading">List of All Authors </h3>
            ...
            %>
             <tr>
                 <td class="text-uppercase" style="color:black;"><%=bauth%></td>
                    <td><a href="singleAuthor.jsp?auth=<%=bauth%>"><button type="submit" class="btn btn-success" role="button">View Books of Author</button></a>
                    </td>
                    <td><a href="deletea.jsp?bid=<%=bno%>"><button type="submit" class="btn btn-danger" role="button">Delete Author &#10008;</button></a>
                    </td>
                </tr>
                 <%  }%>
                </tbody>
                     ...
                     <div class="tab-content">
             <h3 class="form-heading">Add Author</h3>
...
<input class="form-control"  placeholder="Add new Author" name="auth" required>
