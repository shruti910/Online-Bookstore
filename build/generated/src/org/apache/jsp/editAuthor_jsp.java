...
public final class editAuthor_jsp extends org.apache.jasper.runtime.HttpJspBase
...
Class.forName("com.mysql.jdbc.Driver");
    ...
    Statement stmt;
      ...
      out.write("        <title>Edit Author</title>\n");
...
if ((session.getAttribute("userid") == null) || (session.getAttribute("userid") == "")) {
      ...
      out.write("            <h3 class=\"form-heading\">List of All Authors </h3>\n");
 ...
 ps = con.prepareStatement("select * from authdetails");
      ...
      out.print(bauth);
      out.write("</td>\n");
      out.write("                    <td><a href=\"singleAuthor.jsp?auth=");
      out.print(bauth);
      out.write("\"><button type=\"submit\" class=\"btn btn-success\" role=\"button\">View Books of Author</button></a>\n");
      out.write("                    </td>\n");
      out.write("                    <td><a href=\"deletea.jsp?bid=");
      out.print(bno);
      out.write("\"><button type=\"submit\" class=\"btn btn-danger\" role=\"button\">Delete Author &#10008;</button></a>\n");
      out.write("                    </td>\n");
      out.write("                </tr>\n");
      out.write("                 ");
  }
      ...
      out.write("                    \n");
      out.write("                     <div class=\"tab-content\">\n");
      out.write("             <h3 class=\"form-heading\">Add Author</h3>\n");
      ...
      out.write("<input class=\"form-control\"  placeholder=\"Add new Author\" name=\"auth\" required>\n");
 ...
 String ex=" ";
            if(request.getParameter("submit")==null){}
                ...
                try{
    ps = con.prepareStatement("insert into bookstore.authdetails(author) values (?)");
    ps.setString(1,request.getParameter("auth")); 
ps.executeUpdate();
             
      out.write(" <div class=\"alert alert-success\">\n");
      out.write("                 Author Entry Updated\n");
      out.write("</div>\n");
      out.write("            ");
}
catch(Exception e){
 ex=e.getMessage(); 
      ...
      out.write("                var x = document.getElementById(\"myFile\").value;\n");
