<%-- 
    Document   : singleAuthor
    Created on : Jul 11, 2017, 2:32:03 PM
    Author     : User
--%>
            ...
            <div id="page-wrapper" class="container theme-showcase" role="main">
                <div class="tab-content">
                    <div class=" active row" >  
                        <h3 class="form-heading"> Books of <span class='text-uppercase'><%= auth%></span></h3>
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                <tbody>
                                    <% ps = con.prepareStatement("select * from bookdetails where bauthor=?");
                                     ps.setString(1, auth);
                                        rs = ps.executeQuery();
                                        while (rs.next()) {
                 ...
                 <td><img class="img-responsive " src="<%= bsource%>" style='height:100px; width:auto;' alt="image"/></td>
                    <td><a href="single.jsp?bid=<%=bno%>"><button type="submit" class="btn btn-success" role="button">View Product Details</button></a>
                    </td>
                </tr>
                 <%  }%>
                </tbody>
