<%-- 
    Document   : editBook
    Created on : Jul 11, 2017, 3:38:16 PM
    Author     : User
--%>
                            ...
                            <table class="table table-striped table-hover">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="single.jsp?bid=<%=bno%>"><button type="submit" class="btn btn-primary" role="button">View Book Details</button></a>
                                        </td>
                                        <td><a href="editBookDetails.jsp?bid=<%=bno%>"><button type="submit" class="btn btn-warning" role="button">Edit Book Details </button></a>
                                        </td>
                                    </tr>
